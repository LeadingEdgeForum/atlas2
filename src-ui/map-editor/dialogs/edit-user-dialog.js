...
const Constants = require('../single-map-constants');
import SingleMapActions from '../single-map-actions';
const _ = require('underscore');
const createReactClass = require('create-react-class');

const EditUserDialog = createReactClass({
    ...
    _onChange: function () {
        const newState = this.props.singleMapStore.getEditUserDialogState();
                    ...
                    <Modal.Body>
                        <Form horizontal>
                            <FormGroup controlId="name">
                                ...
                                <Col sm={9}>
                                    <FormControl type="text" placeholder="Enter the name of the user"
                                                 onChange={this._handleDialogChange.bind(this, 'name')}
                                                 onKeyDown={this._enterInterceptor} value={name}/>
                                </Col>
                            </FormGroup>
                            <FormGroup controlId="description">
                                ...
                                <Col sm={9}>
                                    <FormControl type="textarea" componentClass="textarea"
                                                 ...
                                                 onKeyDown={this._enterInterceptor} value={description}/>
                                </Col>
                            </FormGroup>
                        </Form>
                    </Modal.Body>
